...
bunx --bun oracle-skills@github:Soul-Brews-Studio/oracle-skills-cli#v1.2.1
...
bunx --bun oracle-skills@github:Soul-Brews-Studio/oracle-skills-cli#v1.2.1 -g
```
...
bunx --bun oracle-skills@github:Soul-Brews-Studio/oracle-skills-cli#v1.2.1 install -y -g

# Install specific skills to specific agent
bunx --bun oracle-skills@github:Soul-Brews-Studio/oracle-skills-cli#v1.2.1 install -y -g -a claude-code -s rrr -s trace

# Uninstall all, no prompts
bunx --bun oracle-skills@github:Soul-Brews-Studio/oracle-skills-cli#v1.2.1 uninstall -y -g
```
